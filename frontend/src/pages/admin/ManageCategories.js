...
const ManageCategories = () => {
    ...
    const displayGroups = ['Weight', 'Month', 'Parcel Type'];
    const editableGroups = ['Parcel Type'];
    const colorOptions = [
    ...
    const handleAdd = async (e) => {
        ...
        try {
            ...
            setAddModal(false);
            setFormData({ name: '', group: 'Parcel Type', color: 'purple' });
            fetchCategories();
                            ...
                            <form onSubmit={handleAdd} className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        required
                                        placeholder="e.g., Shoes, Clothes, Liquids"
                                ...
                                <div>
                                    ...
                                    >
                                        <option value="Parcel Type">Parcel Type</option>
                                    </select>
                                </div>
                                <div>
